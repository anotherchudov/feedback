...
from ducky_transformers.testing_utils import is_pt_flax_cross_test, require_flax, slow
...
if is_flax_available():
    ...
    from ducky_transformers.models.clip.modeling_flax_clip import FlaxCLIPModel, FlaxCLIPTextModel, FlaxCLIPVisionModel
