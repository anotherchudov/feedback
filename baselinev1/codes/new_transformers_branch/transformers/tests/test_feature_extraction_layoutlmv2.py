...
from ducky_transformers.file_utils import is_pytesseract_available, is_torch_available
from ducky_transformers.testing_utils import require_pytesseract, require_torch
