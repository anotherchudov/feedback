...
from ducky_transformers.testing_utils import require_soundfile, require_torch, slow, torch_device
...
if is_torch_available():
    ...
    from ducky_transformers.models.hubert.modeling_hubert import _compute_mask_indices
