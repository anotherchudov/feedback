...
from ducky_transformers.testing_utils import require_tokenizers, require_torch, slow, torch_device
...
if is_torch_available():
    ...
    from ducky_transformers.models.fnet.modeling_fnet import (
