...
from ducky_transformers.testing_utils import require_pytorch_quantization, require_torch, slow, torch_device
...
if is_torch_available():
    ...
    from ducky_transformers.models.qdqbert.modeling_qdqbert import QDQBERT_PRETRAINED_MODEL_ARCHIVE_LIST
