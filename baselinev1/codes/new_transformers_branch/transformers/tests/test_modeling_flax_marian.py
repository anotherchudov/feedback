...
from ducky_transformers.testing_utils import require_flax, require_sentencepiece, require_tokenizers, slow
...
if is_flax_available():
    ...
    from ducky_transformers.models.marian.modeling_flax_marian import FlaxMarianModel, FlaxMarianMTModel, shift_tokens_right
