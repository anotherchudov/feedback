...
from new_transformers import PegasusConfig, PegasusForConditionalGeneration, PegasusTokenizer
from new_transformers.models.pegasus.configuration_pegasus import DEFAULTS, task_specific_params
