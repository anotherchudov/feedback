...
class DisentangledSelfAttention(nn.Module):
    ...
    def disentangled_attention_bias(self, query_layer, key_layer, relative_pos, rel_embeddings, scale_factor):
        ...
        ### DUCKY FIXED
        # print('ducky had visited!')

        # DUCKY MODIFIED - add 256 more space for relative position embedding
        # ----------------------------------------------------
        # rel_embeddings = rel_embeddings[self.pos_ebd_size - att_span : self.pos_ebd_size + att_span, :].unsqueeze(0)
        rel_embeddings = rel_embeddings[self.pos_ebd_size - att_span : self.pos_ebd_size + att_span + 256, :].unsqueeze(0)
        # ----------------------------------------------------
