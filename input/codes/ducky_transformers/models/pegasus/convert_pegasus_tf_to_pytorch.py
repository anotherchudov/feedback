...
from ducky_transformers import PegasusConfig, PegasusForConditionalGeneration, PegasusTokenizer
from ducky_transformers.models.pegasus.configuration_pegasus import DEFAULTS, task_specific_params
